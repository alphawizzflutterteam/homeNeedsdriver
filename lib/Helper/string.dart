...
final Uri getDeliveryBoyDetailApi =
    Uri.parse(baseUrl + 'get_delivery_boy_details');
...
final Uri getAcceptOrderApi = Uri.parse(baseUrl + 'accept_order');
...
const String DELIVERY_BOY_STATUS = 'delivery_boy_status';
